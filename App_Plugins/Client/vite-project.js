...
const at = (r) => new st(typeof r == "string" ? r : r + "", void 0, B), lt = (r, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: dt, defineProperty: pt, getOwnPropertyDescriptor: ut, getOwnPropertyNames: $t, getOwnPropertySymbols: _t, getPrototypeOf: ft } = Object, f = globalThis, K = f.trustedTypes, mt = K ? K.emptyScript : "", z = f.reactiveElementPolyfillSupport, S = (r, t) => r, M = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? mt : null;
      break;
  ...
  return e;
} }, V = (r, t) => !dt(r, t), Z = { attribute: !0, type: String, converter: M, reflect: !1, hasChanged: V };
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const w = globalThis, N = w.trustedTypes, F = N ? N.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, it = "$lit$", _ = `lit$${Math.random().toFixed(9).slice(2)}$`, rt = "?" + _, At = `<${rt}>`, g = document, C = () => g.createComment(""), U = (r) => r === null || typeof r != "object" && typeof r != "function", W = Array.isArray, gt = (r) => W(r) || typeof (r == null ? void 0 : r[Symbol.iterator]) == "function", D = `[ 	
\f\r]`, b = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, G = /-->/g, Q = />/g, m = RegExp(`>|${D}(?:([^\\s"'>=/]+)(${D}*=${D}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), X = /'/g, Y = /"/g, nt = /^(?:script|style|textarea|title)$/i, yt = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), vt = yt(1), v = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), tt = /* @__PURE__ */ new WeakMap(), A = g.createTreeWalker(g, 129);
function ot(r, t) {
...
const Et = (r, t) => {
  ...
  for (let a = 0; a < e; a++) {
    const h = r[a];
    let c, p, l = -1, u = 0;
    for (; u < h.length && (n.lastIndex = u, p = n.exec(h), p !== null); ) u = n.lastIndex, n === b ? p[1] === "!--" ? n = G : p[1] !== void 0 ? n = Q : p[2] !== void 0 ? (nt.test(p[2]) && (i = RegExp("</" + p[2], "g")), n = m) : p[3] !== void 0 && (n = m) : n === m ? p[0] === ">" ? (n = i ?? b, l = -1) : p[1] === void 0 ? l = -2 : (l = n.lastIndex - p[2].length, c = p[1], n = p[3] === void 0 ? m : p[3] === '"' ? Y : X) : n === Y || n === X ? n = m : n === G || n === Q ? n = b : (n = m, i = void 0);
    const $ = n === m && r[a + 1].startsWith("/>") ? " " : "";
    o += n === b ? h + At : l >= 0 ? (s.push(c), h.slice(0, l) + it + h.slice(l) + _ + $) : h + _ + (l === -2 ? a : $);
  }
    ...
    for (; (i = A.nextNode()) !== null && h.length < a; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const l of i.getAttributeNames()) if (l.endsWith(it)) {
          const u = p[n++], $ = i.getAttribute(l).split(_), T = /([.?@])?(.*)/.exec(u);
          h.push({ type: 1, index: o, name: T[2], strings: $, ctor: T[1] === "." ? St : T[1] === "?" ? wt : T[1] === "@" ? Pt : k }), i.removeAttribute(l);
        ...
        if (nt.test(i.tagName)) {
          ...
          if (u > 0) {
            ...
            for (let $ = 0; $ < u; $++) i.append(l[$], C()), A.nextNode(), h.push({ type: 2, index: ++o });
            i.append(l[u], C());
          }
        }
...
class bt {
  ...
  u(t) {
    ...
    for (; h !== void 0; ) {
      if (n === h.index) {
        let c;
        h.type === 2 ? c = new O(o, o.nextSibling, this, t) : h.type === 1 ? c = new h.ctor(o, h.name, h.strings, this, t) : h.type === 6 && (c = new Ct(o, this, t)), this._$AV.push(c), h = s[++a];
      }
...
class k {
  ...
  _$AI(t, e = this, s, i) {
    ...
    let n = !1;
    if (o === void 0) t = E(this, t, e, 0), n = !U(t) || t !== this._$AH && t !== v, n && (this._$AH = t);
    else {
      const a = t;
      let h, c;
      for (t = o[0], h = 0; h < o.length - 1; h++) c = E(this, a[s + h], e, h), c === v && (c = this._$AH[h]), n || (n = !U(c) || c !== this._$AH[h]), c === d ? t = d : t !== d && (t += (c ?? "") + o[h + 1]), this._$AH[h] = c;
    }
    n && !i && this.j(t);
  }
  j(t) {
...
L == null || L(x, O), (w.litHtmlVersions ?? (w.litHtmlVersions = [])).push("3.2.1");
const Ut = (r, t, e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ot = { attribute: !0, type: String, converter: M, reflect: !1, hasChanged: V }, Tt = (r = Ot, t, e) => {
...
var Mt = Object.defineProperty, Nt = Object.getOwnPropertyDescriptor, ht = (r, t, e, s) => {
...
let R = class extends P {
  constructor() {
    super(...arguments), this.title = "Componente di esempio";
  }
  render() {
    return vt`<div>Anteprima del componente: ★ ${this.title}</div>`;
  }
};
R.styles = lt`
    div {
...
R = ht([
  xt("my-preview-element")
], R);
export {
  R as MyPreviewElement
};
//# sourceMappingURL=vite-project.js.map
